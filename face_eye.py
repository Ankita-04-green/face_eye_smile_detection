...
face_cascade = cv2.CascadeClassifier("opencv programs\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier("opencv programs\haarcascade_eye (1).xml")
smile_cascade = cv2.CascadeClassifier("opencv programs\haarcascade_smile.xml")
